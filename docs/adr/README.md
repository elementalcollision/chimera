...
| [0134-hybrid-search-eval.md](./0134-hybrid-search-eval.md) | ADR 0134 — Hybrid BM25 + vector search (Phase 4 / item #6): sqlite-vec over LanceDB; prototype behind `CHIMERA_HYBRID_SEARCH=1` | Accepted (2026-05-24) |
