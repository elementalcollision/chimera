...
# Phase-1 INBOX — v27 target is `_check_uv_installed` doctor check.
...
**SUB-SOAK C of v4.116 wiring** (add-line): Add 'charter_file_count' to ESCALATING_FINISH_REASONS. Depends on v25 + v26 (the chain activator — ships LAST per Q1).
...
>   - target file(s): chimera/core/escalation.py, tests/test_charter_file_count.py
>   - design doc: mind/research/v27-escalation-entry-design.md
>   - remediation doc: mind/research/v27-escalation-entry-remediation.md
>   - atomic op: add-line
...
log "phase-1 INBOX seeded (4 tasks, v27 uv-check target — proven add-one-function shape)"
...
This is the v27 minimal-shape attempt after v20 failed 5 times
