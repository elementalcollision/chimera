...
# Phase-1 INBOX — v26 target is `_check_uv_installed` doctor check.
...
**SUB-SOAK B of v4.116 wiring** (add-call-site): Add call site for check_charter_file_count in act.py. Depends on v25 (the field must exist).
...
>   - target file(s): chimera/core/act.py, tests/test_charter_file_count.py
>   - design doc: mind/research/v26-call-site-design.md
>   - remediation doc: mind/research/v26-call-site-remediation.md
...
log "phase-1 INBOX seeded (4 tasks, v26 uv-check target — proven add-one-function shape)"
...
This is the v26 minimal-shape attempt after v20 failed 5 times
